...
function BookingElement({
  ...
  const startTime = momentTimezone.tz(bookingData.bookingStart, 'Asia/Hong_Kong').format('h.mma')
  const endTime = momentTimezone.tz(bookingData.bookingEnd, 'Asia/Hong_Kong').format('h.mma')
