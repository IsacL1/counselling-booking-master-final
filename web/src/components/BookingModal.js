      ...
      {!!props.selectedBooking && (
        <div className="modal__boday">
          ...
          <p className="modal__paragraph">{`${momentTimezone
              .tz(props.selectedBooking['bookingStart'], 'Asia/Hong_Kong')
            .format('h.mma')} to ${momentTimezone
              .tz(props.selectedBooking['bookingEnd'], 'Asia/Hong_Kong')
              .format('h.mma')}`}
            <p className="modal__paragraph">{`${momentTimezone.tz(props.selectedBooking['bookingStart'], 'Asia/Hong_Kong').format('MMMM Do, YYYY')} to ${momentTimezone.tz(props.selectedBooking['bookingEnd'], 'Asia/Hong_Kong').format('MMMM Do, YYYY')}`}
          </p>
          </p>
