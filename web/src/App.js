...
// deleted floorParams
import { filterParams, capacityParams, onFilterByFloor, onFilterByFeature, onFilterByCapacity, onFilterByAvailablity } from './helpers/filters'
                        ...
                        !!roomData && (
                          <div className="wrapper">
                            ...
                            <div className="wrapper__content--bookings">
                              ...
                              <div>
                              <iframe src="http://192.168.56.1:4000" width="100%" height="600" frameBorder="0" title="chatroom" allowFullScreen />
                              </div>
                            </div>
                          </div>
                        )}
